...
for rel_pth in Config.REL_TARGETS:
    target_pth = os.path.join(Config.extracted_path, rel_pth)
    ...
    if not os.path.exists(target_dir_pth):
        ...
        source_dir_pth = os.path.dirname(os.path.dirname(os.path.join(Config.ori_extracted_path, rel_pth)))
    ...
    if not os.path.exists(target_pth):
        source_pth = os.path.join(Config.ori_extracted_path, rel_pth)
